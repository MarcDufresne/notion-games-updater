    ...
    <div class="fixed top-4 right-4 z-[9999] flex flex-col gap-2">
      <TransitionGroup name="toast">
        <div
          ...
          :key="toast.id"
          :class="[
            'min-w-[300px] max-w-[500px] p-4 rounded-lg shadow-2xl border flex items-start gap-3',
        ...
        >
          ...
          <div class="flex-shrink-0">
            ...
            <svg v-else-if="toast.type === 'success'" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
